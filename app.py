...
PROJECTS = {
    'Fretless Minds — AI-Powered Robotic Ukulele': {
    ...
    'Fault-Tolerant Password Hashing Service': {
    ...
    'Blackjack Simulator with Card Counting': {
...
def cmd_ls(args):
    ...
    files = sorted(DIRECTORY_FILES.get(current, {}).keys())
...
def cmd_cat(args):
    ...
    if current == '/home/user/projects':
        return {'type': 'project', 'data': content}
    return content
